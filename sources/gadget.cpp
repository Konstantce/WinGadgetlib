...
gadget gadgetlib::TEMP_EQ(const gadget& lhs, const gadget& rhs)
{
	return gadget(OP_KIND::NON_TERMINAL_EQ, lhs, rhs);
}
...
gadget gadgetlib::EXTEND(const gadget & a, unsigned bitsize)
{
	return gadget(OP_KIND::EXTEND, a, bitsize);
}
